...
#2019 Dataset and country headers
#df_2019 = pd.read_csv('D:/Downloads/visualise/2019book.csv')
#country_filter_2019 = df_2019['1.1 Place of Birth'].unique()
#country_filter_2019 = np.insert(country_filter_2018,0,'All Countries')
	...
	html.Br(),
		...
		html.Div([
			...
			children=[
				...
				dcc.Link('2019 Data', href='/page-3'),
			]),
...
page_1_layout = html.Div([
	...
	html.Hr(),
	#First chart
    html.Div([dcc.Graph(id='indicator-graphic_2017', style={"display": "block", "margin-left": "auto", "margin-right": "auto",
                                                  "width": "65%"})]),
    html.Div(id='page-1-content'),
	#Second chart
	html.Div([dcc.Graph(id='pie_chart', style={"display": "block", "margin-left": "auto", "margin-right": "auto",
                                                  "width": "65%"})]),
	html.Div(
	className="button_link",
...
page_2_layout = html.Div([
	...
	html.Hr(),
	html.Div([dcc.Graph(id='indicator-graphic_2018', style={"display": "block", "margin-left": "auto", "margin-right": "auto",
                                                  "width": "65%"})]),
    html.Div(id='page-2-content'),
	html.Div([dcc.Graph(id='pie_chart_2018', style={"display": "block", "margin-left": "auto", "margin-right": "auto",
                                                  "width": "65%"})]),
	html.Div(
	className="button_link",
	children=[dcc.Link('Go back to Home', href='/'),])
...
def update_graph(input,selected_city,chart_filtering):
	...
	if input =='Gender' and chart_filtering == 'Age Group':
		...
		gender_name = '<b>Gender by Age Group</b>'
		...
		gender_name = '<b>Gender by Region</b>'
	if input =='Turban Wearing' and chart_filtering == 'Age Group':
		...
		turban_name = '<b>Turban Wearing by Age Group</b>'
		...
		turban_name = '<b>Turban Wearing by Region</b>'
		...
		turban_name = '<b>Turban Wearing by Place of Birth</b>'
	if input =='How voted in EU referendum 2016' and chart_filtering == 'Age Group':
		...
		eu_x_axis = 'Age Group'
		eu_name = '<b>Voted in EU Referendum 2016 by Age Group</b>'
		...
		eu_x_axis = 'Region'
		eu_name = '<b>Voted in EU Referendum 2016 by Region</b>'
		...
		eu_name = '<b>Voted in EU Referendum 2016 by Turban Wearing</b>'
		...
		eu_name = '<b>Voted in EU Referendum 2016 by View of Result</b>'
	if input == 'Turban Wearing':
		return {
			'data': [
				{'x': newxfvalues, 'y': newyfvalues, 'type': 'bar', 'name': 'No', 'width':'0.4'},
				{'x': newxmvalues, 'y': newymvalues, 'type': 'bar', 'name': 'Yes', 'width':'0.4'},
				
			],
			'layout': {
				'title': turban_name,'titlefont':{'size':'22'},
				'yaxis':{
                     'title':'Percentage','titlefont':{'size':'18' },'tickfont':{'size':'15' }},
					 'xaxis': {'title': turban_x_axis,'titlefont':{'size':'18' },'tickfont':{'size':'15' }},
			}
		...
		return {
			'data': [
			   {'x': alllxfvalues, 'y': alllyfvalues, 'type': 'bar', 'name': 'Female', 'width':'0.4'},
				{'x': alllxmvalues, 'y': alllymvalues, 'type': 'bar', 'name': 'Male' , 'width':'0.4'},
			],
			'layout': {
				'title': gender_name,'titlefont':{'size':'22'},
				'yaxis':{ 'title':'Percentage','titlefont':{'size':'18' },'tickfont':{'size':'15' }},
				'xaxis': {'title': gender_x_axis,'titlefont':{'size':'18' },'tickfont':{'size':'15' }},
			}
		}
	elif input == 'How voted in EU referendum 2016':
		return {
			'data': [
			   {'x': no_xvalues, 'y': no_yvalues, 'type': 'bar', 'name': 'Did Not Vote', 'width':'0.3'},
				{'x': leave_xvalues, 'y': leave_yvalues, 'type': 'bar', 'name': 'Voted to Leave', 'width':'0.3'},
				{'x': stay_xvalues, 'y': stay_yvalues, 'type': 'bar', 'name': 'Voted to Stay', 'width':'0.3'},
				
			],
			'layout': {
				'title': eu_name,'titlefont':{'size':'22'},
				'yaxis':{'title':'Percentage','titlefont':{'size':'18' },'tickfont':{'size':'15' }},
				'xaxis': {'title': eu_x_axis,'titlefont':{'size':'18' },'tickfont':{'size':'15' }},
			}
		}
...
def update_graph_2017(input,selected_city,chart_filtering):
	...
	if input =='Gender' and chart_filtering == 'Age Group':
		...
		EU_title = '<b>Brexit Votes by Age Group</b>'
		EU_name = 'Age Group'
	elif input =='How voted in EU referendum 2016' and chart_filtering == 'Region':
		if selected_city == 'All Countries':
			df4 = df.groupby(["18. How voted in EU referendum 2016:", "region"]).size().reset_index(name='count')
		...
		EU_title = '<b>Brexit Votes by Region</b>'
		EU_name = 'Region'
	elif input =='How voted in EU referendum 2016' and chart_filtering == 'Turban Wearing':
		if selected_city == 'All Countries':
			df4 = df.groupby(["18. How voted in EU referendum 2016:", "turban_wearing"]).size().reset_index(name='count')
		...
		EU_title = '<b>Brexit Vote by Turban Wearing</b>'
		...
		EU_title = '<b>View of  result of  referendum to leave  EU (Brexit)?</b>'
...
def update_graph_2018(input_2018,selected_city_2018,chart_filtering_2018):
	...
	if input_2018 =='Gender' and chart_filtering_2018 == 'Age Group':
		...
		alllxmvalues = malevalue1['age_group'].values
		alllymvalues = malevalue1['Percentage'].values
		gender_title = '<b>Gender by Age Group</b>'
		gender_x ='Age Group'
		...
		gender_title = '<b>Gender by Region</b>'
		gender_x ='Region'
	...
	if input_2018 =='Turban Wearing' and chart_filtering_2018 == 'Age Group':
		...
		newxmvalues = newmalevalue['age_group'].values
		newymvalues = newmalevalue['Percentage'].values
		turban_wearing_title = '<b>Turban Wearing by Age Group</b>'
		turban_wearing_x ='Age Group'
		...
		newxmvalues = newmalevalue['region'].values
		newymvalues = newmalevalue['Percentage'].values
		turban_wearing_title = '<b>Turban Wearing by Region</b>'
		turban_wearing_x ='Region'
		...
		newxmvalues = newmalevalue['place_of_birth'].values
		newymvalues = newmalevalue['Percentage'].values
		turban_wearing_title = '<b>Turban Wearing by Place of Birth</b>'
		turban_wearing_x ='Place of Birth'
	if input_2018 =='How often do you undertake spiritual practice?' and chart_filtering_2018 == 'Age Group':
		...
		spritual_title = '<b>Spritual Practice by Age Group</b>'
		spiritual_x='Age Group'
		...
		spritual_title = '<b>Spritual Practice by Gender</b>'
		spiritual_x='Gender'
		...
		spritual_title = '<b>Spritual Practice by Turban Wearing</b>'
		spiritual_x='Turban Wearing'
	if input_2018 == 'Turban Wearing':
		return {
			...
			'layout': {
				'title': turban_wearing_title,'titlefont':{'size':'22'},
				'yaxis':{ 'title':'Percentage','titlefont':{'size':'18' },'tickfont':{'size':'15' }},
				'xaxis':{'title':turban_wearing_x, 'titlefont':{'size':'18' },'tickfont':{'size':'15' }}
			}
		...
		return {
			...
			'layout': {
				'title': gender_title,'titlefont':{'size':'22'},
				'yaxis':{ 'title':'Percentage','titlefont':{'size':'18' },'tickfont':{'size':'15' }},
				'xaxis':{'title':gender_x, 'titlefont':{'size':'18' },'tickfont':{'size':'15' }}
			}
		}
	elif input_2018 == 'How often do you undertake spiritual practice?':
		return {
			'data': [
			   {'x': everyday_xvalues, 'y': everyday_yvalues, 'type': 'bar', 'name': 'Everyday', 'width':'0.12'},
				{'x': few_xvalues, 'y': few_yvalues, 'type': 'bar', 'name': 'A few times a Week', 'width':'0.12'},
				{'x': weekly_xvalues, 'y': weekly_yvalues, 'type': 'bar', 'name': 'Weekly', 'width':'0.12'},
				{'x': monthly_xvalues, 'y': monthly_yvalues, 'type': 'bar', 'name': 'Monthly', 'width':'0.12'},
				{'x': need_to_xvalues, 'y': need_to_yvalues, 'type': 'bar', 'name': 'When I need to', 'width':'0.12'},
				{'x': never_xvalues, 'y': never_yvalues, 'type': 'bar', 'name': 'Never', 'width':'0.12'},
				
			],
			'layout': {
				'title': spritual_title,'titlefont':{'size':'22'},
				'yaxis':{ 'title':'Percentage','titlefont':{'size':'18' },'tickfont':{'size':'15' }},
				'xaxis':{'title':spiritual_x, 'titlefont':{'size':'18' },'tickfont':{'size':'15' }}
                },
			}
...
def update_graph_second_chart(input_2018,selected_city_2018,chart_filtering_2018):
	...
	if input_2018 =='Gender' and chart_filtering_2018 == 'Age Group':
		...
		spritual_title = '<b>Spritual Practice by Age Group</b>'
		spritual_name = '<b>Spritual Practice</b>'
